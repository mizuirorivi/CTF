...
i can't solve, hence i watched writeup.

Apparently, this ploblems relate about `phps`.

i forget about that.

dumn...

anyway, i found index.phps
```php=
//index.php
<?php
...
let's watch cookie.php or cookie.phps
```php=
//cookie.php
<?php
session_start();
...
i guess this site has vuln about desirialization.

so, i'll trying at playground
...
if error occur, output $perm of __str__.
...
so, i hacked using vuln about desirialization.
```php=
//solve.php
<?php
class access_log
